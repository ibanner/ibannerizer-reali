...
function efw_register_dynamic_tags( $dynamic_tags_manager ) {
    ...
    require_once( EFW__PLUGIN_DIR . 'dynamic-tags/efw-loginout-url-dynamic-tag.php' );
    require_once( EFW__PLUGIN_DIR . 'dynamic-tags/award-dynamic-tag.php' );
    ...
    $dynamic_tags_manager->register( new Elementor_Dynamic_Tag_Award_Data() );
    $dynamic_tags_manager->register( new Elementor_Dynamic_Tag_Alumni_Name_Format() );
    $dynamic_tags_manager->register( new EFW_Loginout_url() );
